//peer created first is the one who generates the words. Aren't all of them?
//need thread to wait for all to connect first and them generate?
//need to test with 3+ peers
...
class Client implements Runnable {
    ...
    public Client() throws Exception {
        ...
        th = new Thread(new Word_generator(this.file_path));
        th.start();
    }
